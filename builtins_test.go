...
var builtinPatterns = []struct {
	...
	},
	{
		...
		pattern: AWSSecretAccessKey,
		ref:     referenceAWSSecretAccessKeyFind,
		samples: []string{
			"AWS_SECRET_ACCESS_KEY=0123456789abcdef0123456789abcdef01234567",
			"aws_secret_access_key = 0123456789abcdef0123456789abcdef01234567",
			`{"SecretAccessKey": "0123456789abcdef0123456789ab+/ef01234567"}`,
			"secretAccessKey=0123456789abcdefABCDEF0123456789abcdef01",
			"aws configure set aws_secret_access_key 0123456789abcdef0123456789abcdef01234567",
			"secret-access-key: 0123456789abcdef0123456789abcdef01234567",
			"aws_secret_access_key\t=\t0123456789abcdef0123456789abcdef01234567",
			"aws_secret_access_key='0123456789abcdef0123456789abcdef01234567'",
			"aws_secret_access_key=0123456789abcdefghijklmnopqrstuvwxyzABCD",
			"aws_secret_access_key=0123456789abcdefGHIJKLMNOPQRSTUVWXYZ+/01",
			"aws_secret_access_key" + "                " + "=" + "                " + "0123456789abcdef0123456789abcdef01234567",
		},
		anchors:    []string{"secret_access_key=0123456789abcdef0123", `SecretAccessKey": "0123456789abcdef`},
	...
	},
	{
		...
		samples: []string{
			"AXIOM_TOKEN=xapt-01234567-89ab-cdef-0123-456789abcdef",
			"xapt-01234567-89AB-CDEF-0123-456789ABCDEF",
			"xapt-xapt-01234567-89ab-cdef-0123-456789abcdef",
			"xapt-01234567-89ab-cdef-0123-456789abcdefxapt-01234567-89AB-CDEF-0123-456789ABCDEF",
		},
		anchors:    []string{"xapt-01234567-89ab-cdef"},
		benchmarks: axiomPersonalAccessTokenFindBenchmarks,
	},
	{
	...
	},
	{
		...
		pattern: DockerAccessToken,
		ref:     referenceDockerAccessTokenFind,
		samples: []string{
			"DOCKER_TOKEN=dckr_pat_0123456789abcdef0123456789a",
			"DOCKER_TOKEN=dckr_oat_0123456789abcdef0123456789a",
			"dckr_pat_0123456789abcdef-123456789_",
			"dckr_oat_0123456789abcdef0123456789abcdef",
			"dckr_pat_dckr_pat_0123456789abcdef0123456789a",
			"dckr_oat_dckr_oat_0123456789abcdef0123456789a",
			"dckr_pat_0123456789abcdef0123456789adckr_pat_0123456789abcdef0123456789a",
		},
		anchors:    []string{"dckr_pat_0123456789abcdef", "dckr_oat_0123456789abcdef"},
		benchmarks: dockerAccessTokenFindBenchmarks,
	},
	{
	...
	},
	{
		...
		samples: []string{
			"DT_API_TOKEN=dt0c01.0123456789ABCDEF01234567.0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF",
			"dt0s16.0123456789ABCDEF01234567.0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF",
			"dt0c01.dt0c01.0123456789ABCDEF01234567.0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF",
			"dt0c01.0123456789ABCDEF01234567.0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEFdt0s16.0123456789ABCDEF01234567.0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF0123456789ABCDEF",
		},
		anchors:    []string{"dt0c01.0123456789ABCDEF01234567."},
	...
	},
	{
		...
		samples: []string{
			"SHOPIFY_ACCESS_TOKEN=shpat_0123456789abcdef0123456789abcdef",
			"shpca_0123456789abcdef0123456789abcdef",
			"shppa_0123456789abcdef0123456789abcdef",
			"shpat_0123456789ABCDEF0123456789ABCDEF",
			"shpat_shpat_0123456789abcdef0123456789abcdef",
			"shpat_0123456789abcdef0123456789abcdefshppa_0123456789abcdef0123456789abcdef",
		},
		anchors:    []string{"shpat_0123456", "shpca_0123456", "shppa_0123456"},
		benchmarks: shopifyAccessTokenFindBenchmarks,
	},
	{
		name:    "shopify-app-secret-key",
		pattern: ShopifyAppSecretKey,
		ref:     referenceShopifyAppSecretKeyFind,
		samples: []string{
			"SHOPIFY_API_SECRET=shpss_0123456789abcdef0123456789abcdef",
			"shpss_0123456789abcdef0123456789abcdef",
			"shpss_0123456789ABCDEF0123456789ABCDEF",
			"shpss_shpss_0123456789abcdef0123456789abcdef",
		},
		anchors:    []string{"shpss_0123456"},
		benchmarks: shopifyAppSecretKeyFindBenchmarks,
	},
	{
		name:    "slack-token",
		pattern: SlackToken,
	...
	{
		name:    "tailscale-key",
		pattern: TailscaleKey,
		ref:     referenceTailscaleKeyFind,
		samples: []string{
			"TS_AUTHKEY=tskey-auth-0123456789ab-0123456789abcdef",
			"tskey-api-0123456789ab-0123456789abcdef",
			"tskey-client-0123456789ab-0123456789abcdef",
			"tskey-scim-0123456789ab-0123456789abcdef",
			"tskey-webhook-0123456789ab-0123456789abcdef",
			"tskey-auth-0123456789AB-0123456789ABCDEF",
			"tskey-auth-0-1",
			"tskey-api-tskey-auth-0-1",
			"tskey-auth-0123456789ab-0123456789abcdef tskey-api-0123456789AB-0123456789ABCDEF",
			"tskey-auth-0123456789ab-0123456789abcdef--TL0123456789abcdef-0123456789abcdefghij",
		},
		anchors:    []string{"tskey-auth-0123456789abcdef", "tskey-api-0123456789abcdef"},
