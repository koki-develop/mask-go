...
var builtins = []Pattern{anthropicAPIKey, awsAccessKeyID, githubToken, gitLabToken, googleAPIKey, jsonWebToken, linearAPIKey, notionAPIToken, npmToken, openAIAPIKey, pypiAPIToken, sendGridAPIKey, sentryAuthToken, slackToken, stripeAPIKey}
