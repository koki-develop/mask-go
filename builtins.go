...
var builtins = []Pattern{anthropicAPIKey, awsAccessKeyID, githubToken, gitLabToken, googleAPIKey, grafanaServiceAccountToken, hashiCorpVaultToken, jsonWebToken, linearAPIKey, notionAPIToken, npmAccessToken, openAIAPIKey, pypiAPIToken, sendGridAPIKey, sentryAuthToken, slackToken, stripeAPIKey, supabasePersonalAccessToken}
