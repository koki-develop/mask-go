...
var builtins = []Pattern{anthropicAPIKey, awsAccessKeyID, githubToken, gitLabToken, googleAPIKey, jsonWebToken, npmToken, openAIAPIKey, pypiAPIToken, slackToken, stripeAPIKey}
